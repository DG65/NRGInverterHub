...
class InverterHubEnergy extends IPSModule
{
    ...
    public function ApplyChanges()
    {
        ...
        // Store-Checkliste 9d (13.09.2026): keine Datenpunkte zugewiesen ist
        // bewusst inaktiv, kein Fehler - IS_INACTIVE (104) statt > 200.
    ...
    private function ForumHint(): ?array
    {
        ...
        return [
            ...
            'items' => [
                ...
                ['type' => 'Button', 'caption' => 'Verstanden – nicht mehr anzeigen', 'onClick' => 'IHUBNRG_DismissReviewHint($id);'],
            ],
        ];
    }
